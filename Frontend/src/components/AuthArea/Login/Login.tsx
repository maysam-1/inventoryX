              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-1 text-sm bg-white border-2 border-[#D4C4B0] rounded-lg focus:ring-2 focus:ring-[#A0907D] focus:border-[#A0907D] outline-none pr-12 text-[#6B5744] transition"
